...
% Compute and plot surface

% Surf is useful, but very similar to contour
% They are effectively the same thing, but surf is continuous

% Surf
c = surf(x,y,abs(transpose(mode)));
shading interp % get rid of black grid lines
view(2) % view 2D
cmap = colormap;
% ii = 1;
% cla;
